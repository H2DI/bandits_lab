...
alg_list = [
    algs.UCB_a(K, sig=0.01 * 1.2, label=r"UCB $\sigma = 0.01 \times 1.2$"),
    algs.UCB_a(K, sig=0.1 * 1.2, label=r"UCB $\sigma = 0.1 \times 1.2 $"),
    algs.UCB_a(K, sig=1, label=r"UCB $\sigma = 1 \times 1.2$"),
    algs.UCB_a(K, sig=10 * 1.2, label=r"UCB $\sigma = 10 \times 1.2$"),
    algs.UCB_a(K, sig=100 * 1.2, label=r"UCB $\sigma = 100 \times 1.2 $"),
